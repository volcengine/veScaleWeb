# veScale DModule (Distributed Module) for Tensor Parallel & Sequence Parallel

## TLDR

<img src="../../public/guide/dmodule.png" alt="5D" width="700"/>
...
## How to use veScale DModule _manually_?
...
## How to use write Sharding Plan _manually_?

TODO: 
- high-level concept here
- low-level concept in DTensor
- example in API doc string