...
# veScale Inference General Perf Overview
...
The veScale architecture is shown in the figure below:

<img src={general_framework} alt="general_framework"></img>

## Model Zoo List

The models supported by veScale Inference General Perf are collected under the Model Zoo. From the perspective of access rights, they are currently divided into internal models and open models. Released with veScale is the open model included in the corresponding version.
...
## Vendor List
veScale Inference General Perf Vendor List will be shown below
