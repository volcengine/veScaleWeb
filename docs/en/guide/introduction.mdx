...
- 🌐 **Open Source & Reproducibility**: a great framework should be open-source, ensuring easy access and utilization for companies and research institutions alike.
...
<img src="../../public/guide/overview.png" alt="overview" width="800"/>
